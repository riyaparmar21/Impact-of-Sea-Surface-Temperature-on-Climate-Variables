...
def plot_u10_avg_heatmap(ecmwf_file_path_str, nc_variable_name, output_path_str):
    """
    Plot the time-averaged 10m U-Wind Component (U10) as a heatmap.
    ...
    try:
        ...
        cbar_label = f'U-Wind ({display_units})'
        plot_title = f'Average 10m U-Wind Component'
        cmap = 'RdBu_r' # Diverging colormap for wind components (positive/negative)
        ...
        # Determine symmetric color limits if appropriate for RdBu_r
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Generate a time-averaged heatmap for 10m U-Wind (U10).")
    ...
    plot_u10_avg_heatmap(ecmwf_file, nc_var_name, args.output)