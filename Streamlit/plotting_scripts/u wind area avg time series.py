...
#     plot_ecmwf_data(ecmwf_file, var='u10', plot_type='timeseries')
...
def plot_u10_area_avg_timeseries(ecmwf_file_path_str, nc_variable_name, output_path_str):
    """
    Create an area average timeseries plot for 10m U-Wind Component (U10).
    ...
    try:
        ...
        # Select color for U10 (e.g., from a palette)
        ...
        plt.title(f'10m U-Wind Component (Area Average)', fontsize=14)
        plt.xlabel('Time', fontsize=12)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Generate an area average timeseries plot for 10m U-Wind (U10).")
    ...
    plot_u10_area_avg_timeseries(ecmwf_file, nc_var_name, args.output)