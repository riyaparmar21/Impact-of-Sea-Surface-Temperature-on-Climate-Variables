...
def plot_u10_seasonal_avg_heatmaps(ecmwf_file_path_str, nc_variable_name, output_path_str):
    """
    Plot seasonal average heatmaps for 10m U-Wind Component (U10).
    ...
    try:
        ...
        plt.suptitle(f'Seasonal Average 10m U-Wind Component', fontsize=16)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Generate seasonal average heatmaps for 10m U-Wind (U10).")
    ...
    plot_u10_seasonal_avg_heatmaps(ecmwf_file, nc_var_name, args.output)